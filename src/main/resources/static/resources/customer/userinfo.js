...
$(function () {
    ...
    function queryParams(params) {
        return {
            ...
            yhmc: $.trim($('#cName').val()) === '' ? null : $.trim($('#cName').val()),
            userid: $.trim($('#userCard').val()) === '' ? null : $.trim($('#userCard').val()),
            mobile: $.trim($('#telephone').val()) === '' ? null : $.trim($('#telephone').val())
        };
    }
    ...
    function initTreeView() {
        $.ajax({
            type: "post",
            url: Common.getRootPath() + "/admin/role/tree",
            dataType: "json",
    ...
    $('#infoTable').bootstrapTable({
        url: Common.getRootPath() + '/admin/user/list',// 要请求数据的文件路径
        method: 'GET', // 请求方法
    ...
    $('#infoTable').on('click', 'a[name="edit"]', function (e) {
        ...
        $.ajax({
            url: Common.getRootPath() + '/admin/user/getById',
            data: {'id': userId},
            type: "post",
            dataType: 'json',
            async: false,
    ...
    $('#infoTable').on('click', 'a[name="delete"]', function (e) {
        ...
        Ewin.confirm({message: "确认要删除选择的数据吗？"}).on(function (e) {
            ...
            $.ajax({
                type: "post",
                url: Common.getRootPath() + '/admin/user/deleteById',
                data: {"id": userId},
                dataType: 'json',
    ...
    $('#infoTable').on('click', 'a[name="tree"]', function (e) {
        ...
        $.ajax({
            type: "post",
            url: Common.getRootPath() + "/admin/userrole/query",
            dataType: "json",
            data:{'userId':userId},
            cache : false,
            async: false,
    ...
    $('#saveUser').on('click', function (e) {
        ...
        var url = '';
        if ($('#id').val().length == 0) {
            url = Common.getRootPath() + '/admin/user/add';
        } else {
            url = Common.getRootPath() + '/admin/user/update';
        }
    ...
    $('#saveUserRole').on('click',function(e){
        ...
        if(nodeLength > 0){
            ...
            $.ajax({
                url: Common.getRootPath() + '/admin/userrole/add',
                data: {'idStr':userRole},
                type: "post",
                dataType: 'json',
                async: false,
            ...
            $.ajax({
                url: Common.getRootPath() + '/admin/userrole/delete',
                data: {'userId':userId},
                type: "post",
                dataType: 'json',
                async: false,
